...
{
	[TestFixture]
    class PlaneTypeCreateUpdate
    {
		IUnitOfWork unitOfWork;
		FakePlaneTypeRepository fakePlaneTypeRepository;

		public PlaneTypeCreateUpdate()
		{
			Mapper.Reset();
		...
		public void PilotSetup()
		{
			...
			fakePlaneTypeRepository = new FakePlaneTypeRepository();

			unitOfWork = new UnitOfWork(crewMock.Object, flightMock.Object, pilotMock.Object,
										planeMock.Object, fakePlaneTypeRepository, stewMock.Object,
